...
app.post("/paynow", [parseUrl, parseJson], (req, res) => {
  ...
  var paymentDetails = {
    ...
    customerRest: req.body.Report_name
}
     ...
     checksum_lib.genchecksum(params, config.PaytmConfig.key, function (err, checksum) {
       ...
       var post_req = https.request(options, function(post_res) {
         ...
         post_res.on('end', function(){
           ...
           res.redirect(`https://marketresearchreports.netlify.app/viewBooking?status=${_results.STATUS}&ORDERID=${_results.ORDERID}&date=${_results.TXNDATE}&bank=${_results.BANKNAME}`)
           });
       });
